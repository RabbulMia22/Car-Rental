  ...
  return (
    <div className="max-w-7xl mx-auto mt-14 mb-14 px-4 ">
      <div className="flex flex-col md:flex-row items-center gap-10 mt-24">
        ...
        {/* Image Section */}
        <div className="flex-1 order-1 md:order-2" data-aos="zoom-in-down">
          <motion.img
          animate={{y:[0, 50, 0]}}
        ...
        <div className="flex-1 text-center md:text-left order-2 md:order-1" data-aos="fade-right">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
            ...
            animate={
              {
                color: ["#3B82F6", "#1D4ED8", "#3B82F6", "#60A5FA", "#2563EB", "#3B82F6", "#C084FC", "#8B5CF6", "#7C3AED"],
                transition: { duration: 3, repeat: Infinity, repeatType: "loop" }
              }
            }
            className="text-blue-600">Rent A Car</motion.span> in Bangladesh
          </h2>
