          ...
          >
            ...
            <div className="p-6 flex flex-col">
              ...
              <div className="flex justify-between items-center mt-auto">
                <div className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-5 rounded-xl shadow-md transition-all duration-300 cursor-pointer">
                ...
                <Link to={`/reserve/${car._id}`}>
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-5 rounded-xl shadow-md transition-all duration-300 cursor-pointer">
                    {car.isRented ? "Already Rented" : "Reserve"}
                  </button>
                </Link>
              </div>
            </div>
